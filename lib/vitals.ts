...
const TOM: Record<Registro, string> = {
  ...
  darkside:
    "Camada DARKSIDE — sobreposição de postura pra quando o conteúdo precisa de aço, não de açúcar. (1) Confronto antes do conforto: não começa com 'você consegue', começa com 'você está fazendo errado' ou 'ninguém te contou isso'. (2) Verdade inconveniente: expõe uma verdade que a audiência evita encarar ('seu problema não é falta de conhecimento — é excesso de consumo e falta de execução'). (3) Autoridade de campo: não fala como professor, psicólogo ou coach — fala como quem já viu centenas ou milhares de casos. (4) Sem emoção açucarada: evita 'estamos aqui por você'; prefere 'o mercado não vai diminuir a régua porque você está cansado'. (5) Clareza brutal: frases curtas, sem floreio, sem academicismo, sem complicação. Sensação que tem que gerar: 'a verdade que eu precisava ouvir'.",
};
